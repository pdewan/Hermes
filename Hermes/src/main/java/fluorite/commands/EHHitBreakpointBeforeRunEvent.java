...
public class EHHitBreakpointBeforeRunEvent extends EHProgramExecutionEvent implements EHICommand{

	public EHHitBreakpointBeforeRunEvent() {
		super();
		
	}
//	
	public EHHitBreakpointBeforeRunEvent(boolean debug, boolean terminate, String projectName, int exitValue, boolean hitBreakPoint, boolean stepEnd, 
