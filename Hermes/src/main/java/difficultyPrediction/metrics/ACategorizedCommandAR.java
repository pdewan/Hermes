...
public class ACategorizedCommandAR implements ExecutableCommand{
	public Object execute(Object theFrame) {
//		ObjectEditor.setPropertyAttribute(ACommandToFeatureDescriptor.class, "Command", AttributeNames.DISPLAY_TO_STRING, true);

//		ObjectEditor.setPropertyAttribute(ACommandToFeatureDescriptor.class, "*", AttributeNames.LABEL_WIDTH, 100);
//		ObjectEditor.setPropertyAttribute(ACommandToFeatureDescriptor.class, "*", AttributeNames.COMPONENT_WIDTH, 300);
...
//		ObjectEditor.setPropertyAttribute(APredictionParameters.class, "RatioScheme", AttributeNames.LABEL_WIDTH, 50);
//
