...
//		SarosAccessorFactory.getSingleton().shareFixedProjectWithFixedUser();
	...
	public void create() {
		super.create();
		// Set the title
		setTitle("I am asking someone for help dialog");
		// Set the message
		setMessage(
	...
	private void saveInput() {
		...
		personAskedForHelp = personAskedForHelpText.getText();
	...
	private Text personAskedForHelpText;
	...
	private String personAskedForHelp;
	...
	public String getPersonAskedForHelp() {
		return personAskedForHelp;
	}
	...
	protected void okPressed() {
		...
		try {
			System.out.println("Pressed ok, should send help data");
//		ServerConnection.getServerConnection().sendHelpRequest(helpRequest);
	...
	protected Control createDialogArea(Composite parent) {
		...
		personAskedForHelpText = new Text(parent, SWT.BORDER);
		personAskedForHelpText.setLayoutData(gridData);
