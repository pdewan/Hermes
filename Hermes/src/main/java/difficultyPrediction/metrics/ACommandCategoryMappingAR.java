...
public class ACommandCategoryMappingAR implements ExecutableCommand{
	public Object execute(Object theFrame) {
//		ObjectEditor.setPropertyAttribute(ACommandToFeatureDescriptor.class, "Command", AttributeNames.DISPLAY_TO_STRING, true);

		ObjectEditor.setPropertyAttribute(ACommandCategoryMapping.class, "*", AttributeNames.LABEL_WIDTH, 150);
		ObjectEditor.setPropertyAttribute(ACommandCategoryMapping.class, "*", AttributeNames.COMPONENT_WIDTH, 650);
