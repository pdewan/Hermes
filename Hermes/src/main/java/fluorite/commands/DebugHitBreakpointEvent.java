...
public class DebugHitBreakpointEvent extends ProgramExecutionEvent implements EHICommand{

	public DebugHitBreakpointEvent() {
		super();
		
	}
//	
	public DebugHitBreakpointEvent(boolean debug, boolean terminate, String projectName, String className, int exitValue, boolean hitBreakPoint, boolean stepEnd, 
