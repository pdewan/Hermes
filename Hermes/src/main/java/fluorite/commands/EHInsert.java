...
public class EHInsert extends EHBaseDocumentChangeEvent {

	public EHInsert() {
	}
	
	public EHInsert(int offset, String text, IDocument doc) {
		mOffset = offset;
		mLength = text.length();
	...
	public boolean combine(EHICommand anotherCommand) {
		if (!(anotherCommand instanceof EHInsert)) {
			return false;
		}

		EHInsert nextCommand = (EHInsert) anotherCommand;
