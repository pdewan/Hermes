...
/**
 * Reads the generated feature (output) file and generates events from it that are of 
 * interest to live ratio file listeners 
 * Should probably not generate and replay ratio files at the same time.
 *
 */
public class AFileReplayAnalyzerProcessor extends ALiveRatioFileGenerator{
