...
public class EHDebugHitBreakpointAfterRunEvent extends EHProgramExecutionEvent implements EHICommand{
	public EHDebugHitBreakpointAfterRunEvent() {
		super();
		
	}
//	
	public EHDebugHitBreakpointAfterRunEvent(boolean debug, boolean terminate, String projectName, int exitValue, boolean hitBreakPoint, boolean stepEnd, 
