...
public class EHHitBreakpointBeforeDebugRunEvent extends EHProgramExecutionEvent implements EHICommand{

	public EHHitBreakpointBeforeDebugRunEvent() {
		super();
		
	}
//	
	public EHHitBreakpointBeforeDebugRunEvent(boolean debug, boolean terminate, String projectName, int exitValue, boolean hitBreakPoint, boolean stepEnd, 
