...
public class StatusConsts {
	...
	public final static String SLOW_PROGRESS_STATUS = "Slow Progress";
	public final static String INDETERMINATE = "Indeterminate";
	public final static String COULD_USE_HELP_STATUS = "Could use help";
	public final static String EUREKA_STATUS = "EUREKA!!!";
	public final static String MAKING_PROGRESS_STATUS = "Making Progress";
