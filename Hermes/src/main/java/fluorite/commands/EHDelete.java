...
public class EHDelete extends EHBaseDocumentChangeEvent {
	
	public EHDelete() {
	}

	public EHDelete(int offset, int length, int startLine, int endLine,
	...
	public String getCategory() {
		return EHEventRecorder.DocumentChangeCategory;
	}

	public String getCategoryID() {
		return EHEventRecorder.DocumentChangeCategoryID;
	}
	...
	public boolean combine(EHICommand anotherCommand) {
		if (!(anotherCommand instanceof EHDelete)) {
			return false;
		}

		EHDelete nextCommand = (EHDelete) anotherCommand;
