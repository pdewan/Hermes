...
public class EHDebugHitBreakpointBeforeDebugRunEvent extends EHProgramExecutionEvent implements EHICommand{
	int numEvents;
	public EHDebugHitBreakpointBeforeDebugRunEvent() {
		super();
		
	}
//	
	public EHDebugHitBreakpointBeforeDebugRunEvent(boolean debug, boolean terminate, String projectName, int exitValue, boolean hitBreakPoint, boolean stepEnd, 
