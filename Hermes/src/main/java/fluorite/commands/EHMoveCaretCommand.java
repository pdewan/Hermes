...
public class EHMoveCaretCommand extends MoveCaretCommand implements EHICommand{
	
	public EHMoveCaretCommand() {
		super();
	}
//
	public EHMoveCaretCommand(int caretOffset, int docOffset) {
