...
public class CompilationCommand extends AbstractCommand {
...
//	protected List<Integer> commandNumbers = new ArrayList();
	 ...
	 */
	public CompilationCommand(boolean isWarning, String errorMessage,
...
//			anExistingCommand.getProblemText().equals(aNewCommand.getProblemText());
	...
	public boolean overlaps(CompilationCommand aNewCommand) {
	 ...
	 */
	public static boolean overlaps(CompilationCommand anExistingCommand, CompilationCommand aNewCommand) {
	...
	public boolean equals(CompilationCommand anOther) {
		return 
	...
	public void merge (CompilationCommand aLaterCommand) {
