...
public class DebugHitBreakpointAfterRunEvent extends ProgramExecutionEvent implements EHICommand{
	public DebugHitBreakpointAfterRunEvent() {
		super();
		
	}
//	
	public DebugHitBreakpointAfterRunEvent(boolean debug, boolean terminate, String projectName, String className, int exitValue, boolean hitBreakPoint, boolean stepEnd, 
