...
public class EHInsertStringCommand extends InsertStringCommand implements EHICommand{
//
	public EHInsertStringCommand(String data) {
		super(data);
//		mData = data;
	}
//
...
//		if (!(anotherCommand instanceof EHInsertStringCommand)) {
//			return false;
//		}
//
//		EHInsertStringCommand nextCommand = (EHInsertStringCommand) anotherCommand;
//
