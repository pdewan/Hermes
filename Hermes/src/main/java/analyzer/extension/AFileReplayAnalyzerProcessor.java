...
/**
 * Reads the generated output file and generates the kind of events from it that are of 
 * interest to ratio file listeners that would be generated by the difficulty algorithm.
