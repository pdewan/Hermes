...
public class EHSelectTextCommand extends edu.cmu.scs.fluorite.commands.SelectTextCommand implements EHICommand{

	public EHSelectTextCommand() {
		super();
	}
//	
	public EHSelectTextCommand(int start, int end, int caretOffset, int docStart, int docEnd, int docOffset) {
	super(start, end, caretOffset, docStart, docEnd, docOffset);
//		mStart = start;
//		mEnd = end;
//		mCaretOffset = caretOffset;
	}
	public EHSelectTextCommand(int start, int end, int caretOffset) {
