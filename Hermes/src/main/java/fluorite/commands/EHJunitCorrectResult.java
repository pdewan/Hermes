...
public class EHJunitCorrectResult extends EHAbstractCommand implements EHICommand {

	public static final String XML_Exception_Tag = "exceptionString";
	
	public EHJunitCorrectResult()
	{
		
	}
	
	public EHJunitCorrectResult(String exceptionText)
	{
