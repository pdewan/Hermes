...
public class EHDebugHitBreakpointEvent extends EHProgramExecutionEvent implements EHICommand{

	public EHDebugHitBreakpointEvent() {
		super();
		
	}
//	
	public EHDebugHitBreakpointEvent(boolean debug, boolean terminate, String projectName, int exitValue, boolean hitBreakPoint, boolean stepEnd, 
